...
import com.epam.hw2.dao.TicketDAO;
import com.epam.hw2.dao.UserAccountDAO;
import com.epam.hw2.dao.UserDAO;
import com.epam.hw2.exception.BalanceException;
...
import com.epam.hw2.source.CustomSqlParameterSource;
import com.epam.hw2.dao.EventDAO;
...
public class TicketDAOImpl implements TicketDAO {
    ...
    private static final String GET_TICKETS_BY_EVENT = "SELECT * FROM tickets INNER JOIN users " +
            ...
            " WHERE event_id=? ORDER BY users.email";
    ...
    public List<Ticket> getBookedTickets(Event event, int pageSize, int pageNum) {
        ...
        Object[] args = new Object[]{event.getId()};
