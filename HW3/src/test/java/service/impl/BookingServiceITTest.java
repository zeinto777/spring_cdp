...
public class BookingServiceITTest {
    ...
    @Before
    public void setUp() {
        eventService.assignAuditorium(1L, 1L, new DateTime(2016, 9, 3, 12, 5, 0, 0));

        LuckyWinnerAspect luckyWinnerAspect = new LuckyWinnerAspect();
        luckyWinnerAspect.setRandomFactor(0);
    }
   ...
   /* @Test
    ...
    public void testGetEventByName() {
        ...
        List<Event> expected = asList(event);

        List<Event> result = eventService.getByName("movie_1");
    ...
    public void testGetTicketPrice_expectedIncreasePrice_IfEventHaveHighRating() {
        ...
        long result = bookingService.getTicketPrice(1L, 1L, new DateTime(2016, 9, 3, 12, 5, 0, 0), seats, 1L);
    ...
    public void testGetTicketPrice_expectedDiscountIfTodayUserBirthday() {
        ...
        long result = bookingService.getTicketPrice(1L, 1L, new DateTime(currentDate), seats, registerUser.getId());
    ...
    public void testBookTicket_expectedAddTicketToTicketList() {
        List<Long> seats = asList(new Long(23));
        Ticket ticket = new Ticket(1l, 1L, 1L, parseDate("2014-01-14"), seats);
    ...
    public void testAssignAuditorium_ExpectedFalseIfAuditoriumIsAlreadyBooked() {
        boolean result = eventService.assignAuditorium(1L, 1L, new DateTime(2016, 9, 3, 12, 5, 0, 0));
    ...
    public void testAssignAuditorium_ExpectedTrueIfAuditoriumIsNotBooked() {
        boolean result = eventService.assignAuditorium(1L, 1L, new DateTime(2017, 9, 3, 12, 5, 0, 0));
