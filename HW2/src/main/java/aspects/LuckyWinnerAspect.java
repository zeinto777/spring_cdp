...
public class LuckyWinnerAspect {
    ...
    public boolean adviceGetBookTicket(ProceedingJoinPoint proceedingJoinPoint, Ticket ticket) throws Throwable {
        Event event = eventService.getById(ticket.getEventId());
        if (randomBoolean()) event.setTicketPrice(0);
        return (boolean) proceedingJoinPoint.proceed(new Object[]{ticket});
    }
